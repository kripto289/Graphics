...
namespace UnityEditor.Experimental.Rendering.Universal
{
    internal static class Renderer2DUpgrader
    {
        ...
        [MenuItem("Edit/Rendering/Materials/Convert All Built-in Scene Materials to UniversalRP 2D Renderer", false, priority = CoreUtils.Sections.k_Section1 + CoreUtils.Priorities.k_EditMenuPriority + 3)]
        ...
        [MenuItem("Edit/Rendering/Materials/Convert All Built-in Materials to UniversalRP 2D Renderer", true)]
        [MenuItem("Edit/Rendering/Materials/Convert All Built-in Scene Materials to UniversalRP 2D Renderer", true)]
        ...
        [MenuItem("Edit/Rendering/Lights/Convert Project Parametric Lights to Freeform", false, priority = CoreUtils.Priorities.k_EditMenuPriority + 1)]
        public static void UpgradeParametricLightsInProject()
        {
            UpgradeParametricLightsInProject(true);
        }

        [MenuItem("Edit/Rendering/Lights/Convert Scene Parametric Lights to Freeform", false, priority = CoreUtils.Priorities.k_EditMenuPriority + 2)]
